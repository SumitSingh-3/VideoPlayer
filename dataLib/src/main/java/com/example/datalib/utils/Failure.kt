...
sealed class Failure(open val title: String, open val msg: String, open val reason: Throwable?) :
    ...
    class RemoteFailure(title: String, msg: String, ex: RemoteException) : Failure(title, msg, ex) {
        constructor(title: String, ex: RemoteException) : this(title, ex.message ?: String(), ex)
        constructor(ex: RemoteException) : this("Something went wrong!", ex.message ?: String(), ex)
    }
